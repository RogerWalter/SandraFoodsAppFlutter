...
class _AdicionarItemState extends State<AdicionarItem> {
  ...
  void initState() {
    ...
    super.initState();
    _selecionados.add(widget.item_add);
  ...
  preencher_adicionais_item() async{
    ...
    if(widget.item_add.grupo == 2 && widget.item_add.tipo == 1){//CREPES SALGADO
      _hint_obs = "Ex.: Sem queijo por fora meus queridos!";
    }
    if(widget.item_add.grupo == 2 && widget.item_add.tipo == 2){//CREPES DOCE
      _hint_obs = "Ex.: Capricha nesse chocolate aí Sandra!";
    }
    if(widget.item_add.grupo == 3 && widget.item_add.tipo == 1){//TAPIOCA SALGADO
      _hint_obs = "Ex.: Quero com a massa mais fina meus lindão!";
    }
    if(widget.item_add.grupo == 3 && widget.item_add.tipo == 2){//TAPIOCA DOCE
    ...
    if(widget.item_add.grupo == 4 && widget.item_add.tipo == 2){//PASTEL DOCE
    ...
    if(widget.item_add.grupo == 6){//BEBIDAS
      _hint_obs = "Ex.: Quero sem gelo pfvr meus queridos!";
    }
    if(widget.item_add.grupo == 7){//OUTROS
  ...
  salvar_item(){
    ...
    item_add.id_pedido = "-";
    item_add.nome_item = widget.item_add.nome;
    item_add.desc_item = widget.item_add.desc_item;
    ...
    item_add.grupo_item = widget.item_add.grupo;
    item_add.tipo_item = widget.item_add.tipo;
    ...
    if(controller_mobx.lista_itens_pedido.length > 0){
      ...
      if(indice_encontrado != -1){
        ...
        controller_mobx.adiciona_item_ao_pedido(item_add);
      }
    }
    else{
      controller_mobx.adiciona_item_ao_pedido(item_add);
